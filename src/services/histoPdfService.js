...
const buildHistoriqueApproPdf = (res, rows, filters = {}) => {
  ...
  const rowMapper = (r) => [
    ...
    {
      main: r.type_appro === 'transfert' ? 'Transf.' : (r.type_appro === 'produit_transforme' ? 'PT' : (r.type_appro === 'vente' ? 'Vente' : (r.type_appro ? 'Manuel' : '—'))),
      mainColor: r.type_appro === 'transfert' ? '#0369a1' : (r.type_appro === 'produit_transforme' ? '#7e22ce' : (r.type_appro === 'vente' ? '#6d28d9' : '#059669')),
    },
