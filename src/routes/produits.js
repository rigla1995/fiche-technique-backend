...
const { toggleStockIngredient, deleteStockPTHistory, setLinkedIngredient } = require('../controllers/produitTransformeController');
...
router.put('/:id/link-ingredient', authenticate, requireClient, setLinkedIngredient);
